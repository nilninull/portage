...
SRC_URI="https://downloads.bitwig.com/stable/${MY_PV}/${PN}-${MY_PV}.deb"
LICENSE="Bitwig"
SLOT="0"
KEYWORDS="~amd64"
RESTRICT="mirror"

IUSE="abi_x86_32 jack pipewire cpu_flags_x86_sse4_1"
REQUIRED_USE="cpu_flags_x86_sse4_1"

# jack? || ( media-sound/jack2 media-video/pipewire[jack-sdk(-)] )
DEPEND=""
RDEPEND="${DEPEND}
	app-arch/bzip2
	dev-libs/expat
...
src_install() {
	...
	sed -e 's/Categories=.*/Categories=AudioVideo;Audio;AudioVideoEditing/'	\
		-e 's/^Version=.*/Version=1.0/'										\
		-i usr/share/applications/com.bitwig.BitwigStudio.desktop ||
