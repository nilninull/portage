...
EGIT_SUBMODULES=( '*' -'Libraries/pthread-win32' -'Libraries/cpath' -./JUCE -JUCE )
...
src_unpack() {
	...
	git-r3_src_unpack
	# FIX: .gitmodules bug
	git-r3_fetch https://github.com/plugdata-team/JUCE.git 04832aad6b32f41f6c7ff4a6cdec329b39c0c8db
	git-r3_checkout https://github.com/plugdata-team/JUCE.git ${S}/Libraries/JUCE
}
